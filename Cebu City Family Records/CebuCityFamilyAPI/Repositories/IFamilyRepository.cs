...
namespace CebuCityFamilyAPI.Repositories
{
    public interface IFamilyRepository
    {
        ...
        public Task<IEnumerable<Family>> GetFamilyByName(String name);
        ...
        /*/// <summary>
        /// Deletes an existing Family in the Database using their Family <paramref name="name"/>
        /// </summary>
        /// <param name="name">A String representing the Family Name</param>
        /// <returns>The number of row(s) affected in the Database</returns>
        public Task<int> DeleteFamily(String name);*/
